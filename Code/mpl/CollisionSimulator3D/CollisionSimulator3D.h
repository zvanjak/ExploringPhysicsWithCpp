...
namespace MPL
{
	...
	public:
		...
		bool Serialize(std::string fileName, const SimResultsCollSim3D& simResults, double dT, int saveEveryNSteps = 1)
		{
			...
			return Serializer::SaveParticleSimulation3D(fileName, numBalls, _box._width, _box._height, _box._depth, simResults.BallPosList, ballColors, ballRadius, dT, saveEveryNSteps);
		}
	};
}
